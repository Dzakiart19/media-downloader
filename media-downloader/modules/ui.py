...
{self.c('header')}
  __  __          _ _         ____                      _                 _
 |  \\/  |        | (_)       / __ \\                    | |               | |
 | \\  / | ___  __| |_  __ _ | |  | |_ __   ___ _ __ __ | | ___   __ _  __| |
 | |\\/| |/ _ \\/ _` | |/ _` || |  | | '_ \\ / _ \\ '_ ` _ \\| |/ _ \\ / _` |/ _` |
 | |  | |  __/ (_| | | (_| || |__| | | | |  __/ | | | | | | (_) | (_| | (_| |
 |_|  |_|\\___|\\__,_|_|\\__,_| \\____/|_| |_|\\___|_| |_| |_|_|\\___/ \\__,_|\\__,_|
{self.c('end')}
{self.c('primary')}                        v1.0.0 - Dibuat oleh AI Agent Jules{self.c('end')}
        """
        print(header)
